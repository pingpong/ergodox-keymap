 ...
 * |--------+------+------+------+------+------| Shift|           |  ]   |------+------+------+------+------+---------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  | +Alt |           |      |N/~L1 |M/Ctrl|   ,  |   .  |   /  |'/RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+---------'
 *   | L1   | Alt  |  Gui |Ctrl+Alt|Gui |                                       |ESC/L1| LEFT | DOWN |  UP  |  RIGHT  |
 *   `----------------------------------'                                       `-------------------------------------'
 *                                        ,-------------.       ,-----------------.
 *                                        |      |Enter |       |Gui+Space|       |
 *                                 ,------|------|------|       |---------+-------+------.
 ...
 *                                 |      |ace   | Gui  |       | Gui+Alt | +Space|      |
 *                                 `--------------------'       `------------------------'
 */
[BASE] = LAYOUT_ergodox_pretty(
  // left hand
  KC_ESC,   KC_1,        KC_2,     KC_3,          KC_4,    KC_5,    KC_TRNS,         KC_BSLS,         KC_6,          KC_7,            KC_8,    KC_9,    KC_0,             KC_BSPC,
  KC_TAB,   KC_Q,        KC_W,     KC_E,          KC_R,    KC_T,    KC_ESC,          KC_LBRC,         KC_Y,          KC_U,            KC_I,    KC_O,    KC_P,             KC_MINS,
  KC_LCTL,  KC_A,        KC_S,     KC_D,          KC_F,    KC_G,                                      KC_H,          KC_J,            KC_K,    KC_L,    LT(MDIA,KC_SCLN), KC_EQL,
  KC_LSFT,  CTL_T(KC_Z), KC_X,     KC_C,          KC_V,    KC_B,    LSFT(KC_LALT),   KC_RBRC,         LT(SYMB,KC_N), RCTL_T(KC_M),    KC_COMM, KC_DOT,  KC_SLSH,          SFT_T(KC_QUOT),
  TG(SYMB), KC_LALT,     KC_LGUI,  LCTL(KC_LALT), KC_LGUI,                                                           LT(SYMB,KC_ESC), KC_LEFT, KC_DOWN, KC_UP,             KC_RGHT,
                                                           KC_TRNS, KC_ENT,          RGUI(KC_SPC),    KC_TRNS,
                                                                    TT(SYMB),        LT(SYMB,KC_ESC),
                                                  KC_SPC,  KC_BSPC, KC_LGUI,         KC_GRV,          RCTL(KC_SPC),  KC_ENT
),
