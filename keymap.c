...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_TAB,   KC_Q,        KC_W,     KC_E,          KC_R,         KC_T,    KC_TRNS,          KC_LBRC,         KC_Y,          KC_U,         KC_I,    KC_O,    KC_P,             KC_EQL,
  ...
  KC_GRV,   KC_LALT,     LCTL(KC_LALT), KC_LALT,KC_LGUI,                                                                   KC_LEFT,      KC_DOWN, KC_UP,   KC_RGHT,          KC_ESC,
                                                 ...
                                                 KC_SPC,        KC_BSPC, LT(SYMB,KC_GRV),  LGUI(KC_GRV), LCTL(KC_SPC),  KC_ENT
),
...
[MDIA] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_TRNS, KC_TRNS,
