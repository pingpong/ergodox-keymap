 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Cntl   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2|' / Cmd |
 * |--------+------+------+------+------+------| Hyper|           |  Fn  |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1| Opt  |  Cmd | Left | Right|                                       |  Up  | Down |   [  |   ]  |   =  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | Opt  | Cmd  |       | Alt  |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Tab  |       | PgUp |        |      |
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LSFT,         CTL_T(KC_Z), KC_X,          KC_C,    KC_V,    KC_B,    ALL_T(KC_NO),                  TT(SYMB), KC_N,    KC_M,    KC_COMM, KC_DOT,           CTL_T(KC_SLSH), KC_RSFT,
  LT(SYMB,KC_GRV), KC_LALT,     KC_LGUI,    KC_LEFT, KC_RGHT,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, KC_EQL,
                                                                KC_LALT, KC_LGUI,                   KC_LALT, CTL_T(KC_ESC),
                                                                          KC_TAB,                  KC_PGUP,
                                                         KC_SPC, KC_BSPC, KC_LCTL,                  KC_PGDN, KC_TAB, KC_ENT
),
